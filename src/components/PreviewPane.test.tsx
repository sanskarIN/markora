...
describe('PreviewPane', () => {
  ...
  it('blocks javascript links before the open callback', () => {
    ...
    renderWithProviders(<PreviewPane markdown={'[unsafe](javascript:alert(1))'} onOpenLink={onOpenLink} />);
  ...
  it('delegates safe links to the platform adapter', () => {
    const onOpenLink = vi.fn();
    renderWithProviders(<PreviewPane markdown={'[docs](https://example.com/docs)'} onOpenLink={onOpenLink} />);
